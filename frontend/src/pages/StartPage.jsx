...
export default function StartPage() {
  ...
  const [targetGoal, setTargetGoal] = useState(
    ...
    goalFromState === 'deeplearning' ? 'Master deep learning, neural networks, and generative AI' :
    goalFromState === 'nlp_llm' ? 'Master Natural Language Processing, LLMs, and RAG pipelines' :
    goalFromState === 'cv_vision' ? 'Master Computer Vision, OpenCV, and object detection' :
    goalFromState === 'mlops' ? 'Master MLOps, Docker, Kubernetes, and model deployment' :
    goalFromState === 'datascience' ? 'Master Data Science, EDA, statistical modeling, and SQL' : ''
  );
