...
TOPIC_CATALOG = {
    ...
    "agentic ai": {
        "aliases": ["agentic ai", "agentic", "ai agents", "agentic workflows", "autonomous agents", "agentic reasoning", "ai agent", "multi agent"],
        "prerequisites": ["python", "llm", "prompt engineering", "rag"],
        "videos": {
            "beginner": [
                {"title": "Agentic AI & AI Agents Explained", "channel": "freeCodeCamp.org", "url": "https://www.youtube.com/watch?v=F8NKVhkZZWI"},
                {"title": "What is Agentic AI? Complete Guide", "channel": "IBM Technology", "url": "https://www.youtube.com/watch?v=sal78ACtGTc"},
            ],
            "intermediate": [
                {"title": "Building Autonomous AI Agents with LangChain", "channel": "DeepLearning.AI", "url": "https://www.youtube.com/watch?v=1bUy-1hGZpI"},
                {"title": "Multi-Agent Workflows with AutoGen & CrewAI", "channel": "Krish Naik", "url": "https://www.youtube.com/watch?v=F8NKVhkZZWI"},
            ],
            "advanced": [
                {"title": "Advanced Agentic AI Architecture & Tool Calling", "channel": "DeepLearning.AI", "url": "https://www.youtube.com/watch?v=sal78ACtGTc"},
            ],
        },
        "courses": [
            {"title": "AI Agents in Practice", "provider": "DeepLearning.AI", "url": "https://www.deeplearning.ai/short-courses/", "certificate": True},
            {"title": "Building Agentic Workflows", "provider": "Coursera", "url": "https://www.coursera.org/learn/generative-ai-with-llms", "certificate": True},
        ],
        "project": "Build an Autonomous Research Agent that accepts a user query, searches external tools/APIs, reflects on results, and generates a structured report.",
    },
    "vector database": {
        "aliases": ["vector database", "vector search", "pinecone", "chromadb", "weaviate", "faiss", "milvus", "vector db"],
        "prerequisites": ["python", "rag", "transformers"],
        "videos": {
            "beginner": [
                {"title": "Vector Databases Explained Simply", "channel": "StatQuest", "url": "https://www.youtube.com/watch?v=QdDoFfkV41U"},
                {"title": "What is a Vector Database?", "channel": "IBM Technology", "url": "https://www.youtube.com/watch?v=klTvEwg3oJ4"},
            ],
            "intermediate": [
                {"title": "Building Vector Search with ChromaDB & Pinecone", "channel": "freeCodeCamp.org", "url": "https://www.youtube.com/watch?v=QdDoFfkV41U"},
            ],
            "advanced": [
                {"title": "HNSW and Vector Indexing Algorithms", "channel": "DeepLearning.AI", "url": "https://www.youtube.com/watch?v=klTvEwg3oJ4"},
            ],
        },
        "courses": [
            {"title": "Vector Databases for AI Applications", "provider": "DeepLearning.AI", "url": "https://www.deeplearning.ai/short-courses/", "certificate": True},
        ],
        "project": "Build a similarity search engine over course documents using ChromaDB and embedding vectors.",
    },
}
